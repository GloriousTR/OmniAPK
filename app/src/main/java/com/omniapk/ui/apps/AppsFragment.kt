...
class AppsFragment : Fragment() {
    ...
    private fun setupTabs() {
        ...
        val fragments = listOf(
            TabContentFragment.newInstance(TabContentFragment.TAB_FOR_YOU, isGame = false),
            TabContentFragment.newInstance(TabContentFragment.TAB_TOP_CHARTS, isGame = false),
            TabContentFragment.newInstance(TabContentFragment.TAB_CATEGORIES, isGame = false)
        )
