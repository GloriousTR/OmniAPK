/*
 * OmniAPK - F-Droid For You Fragment
 * Shows recommended/featured F-Droid apps from Room cache
 */
...
@AndroidEntryPoint
class FDroidForYouFragment : Fragment() {
    ...
    private fun loadApps() {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            try {
                val apps = fdroidAppDao.getRecentApps(30)
                updateUI(apps)
            } catch (e: Exception) {
                updateUI(emptyList())
            }
